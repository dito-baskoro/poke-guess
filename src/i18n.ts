...
const messages = {
  en: {
    ...
    challenge: {
      ...
      casualDescription: 'No time limit. 3 lives.',
      challengingDescription: '30 seconds per Pokémon. 2 lives.',
      start: 'Start',
      gameOver: 'Game Over',
  ...
  id: {
    ...
    challenge: {
      ...
      casualDescription: 'Tanpa batas waktu. 3 nyawa.',
      challengingDescription: '30 detik per Pokémon. 2 nyawa.',
      start: 'Mulai',
      gameOver: 'Game Over',
